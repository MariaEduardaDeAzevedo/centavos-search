...
import {
  Search, DollarSign, Heart, GitHub, Menu, ChevronDown,
} from 'react-feather';
        ...
        <div className="menu">
          <Dropdown>
            ...
            <Dropdown.Menu className="drop">
              <Dropdown.Item target="_blank" href="https://github.com/MariaEduardaDeAzevedo/centavos-search" className="drop-item">
                Contibua no GitHub
                <GitHub />
              </Dropdown.Item>
          ...
          <button className="no-styled-btn" onClick={navigateHome} type="button">
            <h3>
              <DollarSign />
              {' '}
              <span>CENTAVOS SEARCH</span>
            </h3>
          </button>
        </div>
        ...
        <div className="form">
          <Dropdown
            ...
            onSelect={(k, e) => {
              ...
              setOrder({
                key, direction, name: `${e.target.text}`, icon,
              });
            }}
          >
            ...
            <Dropdown.Menu className="actionbar__menu">
              <Dropdown.Item className="actionbar__menuItem" eventKey="cents:asc">
                Centavos
                <ImSortAmountAsc />
              </Dropdown.Item>
              <Dropdown.Item className="actionbar__menuItem" eventKey="cents:desc">
                Centavos
                <ImSortAmountDesc />
              </Dropdown.Item>
              <Dropdown.Item className="actionbar__menuItem" eventKey="date:asc">
                Data
                <ImSortAmountAsc />
              </Dropdown.Item>
              <Dropdown.Item className="actionbar__menuItem" eventKey="date:desc">
                Data
                <ImSortAmountDesc />
              </Dropdown.Item>
              <Dropdown.Item className="actionbar__menuItem" eventKey="description:asc">
                Descrição
                <ImSortAmountAsc />
              </Dropdown.Item>
              <Dropdown.Item className="actionbar__menuItem" eventKey="description:desc">
                Descrição
                <ImSortAmountDesc />
              </Dropdown.Item>
              <Dropdown.Item className="actionbar__menuItem" eventKey="mode:asc">
                Ambiente
                <ImSortAmountAsc />
              </Dropdown.Item>
              <Dropdown.Item className="actionbar__menuItem" eventKey="mode:desc">
                Ambiente
                <ImSortAmountDesc />
              </Dropdown.Item>
            </Dropdown.Menu>
